...
const LinkIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    strokeLinejoin="round"
  >
    <path d="M10 13a5 5 0 0 0 7.54.54l1.82-1.82a4 4 0 0 0-5.66-5.66L12 7" />
    <path d="M14 11a5 5 0 0 0-7.54-.54L4.64 12.3a4 4 0 0 0 5.66 5.66L12 17" />
  </svg>
);
      ...
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        >
          <div className="absolute w-16 h-16 rounded-full bg-gradient-to-br from-purple-500 via-blue-500 to-teal-500 animate-pulse flex items-center justify-center z-10">
            ...
            />
            <div className="w-8 h-8 rounded-full bg-white/80 backdrop-blur-lg" />
          </div>
                      ...
                      {item.relatedIds.length > 0 && (
                        <div className="mt-4 pt-3 border-t border-white/10">
                          <div className="flex items-center mb-2">
                            <LinkIcon className="w-3 h-3 text-white/70 mr-1" />
                          ...
                          <div className="flex flex-wrap gap-1">
                            {item.relatedIds.map((relatedId) => {
                              ...
                              return (
                                ...
                                >
                                  {relatedItem?.title}
                                  <ArrowRightIcon className="w-2 h-2 ml-1 text-white/60" />
                                </Button>
                              );
                            })}
                          </div>
