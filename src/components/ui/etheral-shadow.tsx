    ...
    >
      ...
      >
        ...
        {subtitle ?? (
          <p className="mt-4 max-w-xl text-center text-base text-zinc-200 md:text-lg mx-auto">
            Надежный подрядчик для вашего бизнеса. Разрабатываем инновационные
            технологические решения и IT продукты.
          </p>
        )}
      </div>
      ...
      {scrollTargetId && (
        ...
        >
          <a
            href={`#${scrollTargetId}`}
            className="text-3xl text-white/70 transition-colors hover:text-white"
          >
            ↓
          </a>
        </div>
